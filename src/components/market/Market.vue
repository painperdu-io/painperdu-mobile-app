<template>
  <div class="markets-container animated" transition="fade">
    <div v-if="markets.length" class="markets-slider">
      ...
      <div class="market-container  animated {{ sliderAnimation }}" v-touch:swipeleft="moveRight" v-touch:swiperight="moveLeft" v-touch:swipedown="loadMarketDetails(market._id)">
